/**
 * Created by chengpeng on 5/8/17.
 */
...
public class SentimentAnalysis {
    ...
    public static class SentimentSplit extends Mapper<Object, Text, Text, IntWritable> {
        ...
        /*
        Create a HashMap for mapping words to emotion labels from a category file.
         */
        ...
        public void setup(Context context) throws IOException {
            ...
            while (line != null) {
                String[] word_label = line.split("\t");
                emotionDic.put(word_label[0].toLowerCase(), word_label[1]);
                line = br.readLine();
            }
        ...
        /*
        Read data from a block of input file, process and write out the key-value pairs
         */
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            for (String word : words){
                if (emotionDic.containsKey(word.trim().toLowerCase())) {
                    context.write(new Text(emotionDic.get(word.toLowerCase())), new IntWritable(1));
                }
    ...
    public static class SentimentCollection extends Reducer<Text, IntWritable, Text, IntWritable> {
        ...
        /*
        Combine data from mapper, sum the count for each sentiment
         */
